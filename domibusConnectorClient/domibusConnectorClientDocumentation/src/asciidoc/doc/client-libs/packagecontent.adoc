...
image::domibusConnectorClient-Libraries-PackageContent.png[domibusConnectorClientLibrariesPackageContent,300,200]
...
NOTE: You can also integrate it directly via maven dependency into your application.
