...
//		setHeight("100vh");
	...
	public void loadMessageDetails(Long connectorMessageId) {
		...
		if(!messageByConnectorId.getEvidences().isEmpty()) {
			...
			grid.addColumn(DomibusConnectorClientConfirmation::getConfirmationType).setHeader("Confirmation Type").setWidth("300px");
			...
			grid.addColumn(DomibusConnectorClientConfirmation::getStorageStatus).setHeader("Storage Status").setWidth("300px");
