...
public class SentMessagesTab extends MessagesTab {
    ...
    public String getMessageStatus(Message msg) {
        if (msg.getMessageDir().getName().contains("_")) {
            ...
            switch (postfix) {
                case DomibusConnectorRunnableConstants.MESSAGE_NEW_FOLDER_POSTFIX:
                    return STATUS_NEW;
                case DomibusConnectorRunnableConstants.MESSAGE_READY_FOLDER_POSTFIX:
                    return STATUS_READY;
                case DomibusConnectorRunnableConstants.MESSAGE_PROCESSING_FOLDER_POSTFIX:
                    return STATUS_PROCESSING;
                case DomibusConnectorRunnableConstants.MESSAGE_SENT_FOLDER_POSTFIX:
                    return STATUS_SENT;
                case DomibusConnectorRunnableConstants.MESSAGE_FAILED_FOLDER_POSTFIX:
                    return STATUS_FAILED;
                case DomibusConnectorRunnableConstants.MESSAGE_SENDING_FOLDER_POSTFIX:
