...
COMMAND_LINE="$JAVA_PATH -cp $CLASSPATH -Dconnector-client.properties=$CONNECTOR_PROPERTIES -Dlogging.properties=$LOGGING_PROPERTIES eu.domibus.connector.client.runnable.DomibusConnector"
